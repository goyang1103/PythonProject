# score_file = open("./O322score.txt", "wt", encoding="utf-8")
...
# score_file = open("./O322score.txt", "r", encoding="utf-8")
# read() 함수 : 파일 내의 모든 내용을 읽어 하나의 문자열로 반환
# print(score_file.read())
# score_file.close()
# readline() 함수 : 한 라인씩 읽어 문자열로 반환, 파일의 끝에 도달하면 None 값이 반환 됨
# while True:
...
#     print(line, end="")
# score_file.close()
with open("./O322score.txt", "r", encoding="utf-8") as score_file:
