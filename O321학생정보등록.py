# 딕셔너리를 사용해 학생의 인적 사항 등록, 검색, 저장, 불러오기 기능 구현
# 저장한 Rest API의 기본 형태인 JSON 으로 저장 및 불러오기 (웹에서 API의 기본 포맷)
# 함수로 구현
...
# 학생 정보 저장
def save_student():
    with open('O321student.json', 'w', encoding='utf-8') as file:
...
def load_student():
    try:
        with open('O321student.json', 'r', encoding='utf-8') as file:
